        ...
        <form class="modal-content" id="demoForm">
          <div class="modal-body">
            ...
            <div class="text-center">
              <img src="" alt="..." class="img-fluid mb-3" style="width: 50px">
            </div>
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              ...
              <div class="collapse show" id="sidebarDashboards">
                <ul class="nav nav-sm flex-column">
                  <li class="nav-item">
                    <a href="" class="nav-link {{ (request()->is('panel/paginas/inicio*')) ? 'active' : '' }}">
                      Inicio
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="" class="nav-link {{ (request()->is('panel/data/productos*')) ? 'active' : '' }}">
                      Productos
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="" class="nav-link {{ (request()->is('panel/data/productos/ofertas')) ? 'active' : '' }}">
                      Ofertas
                    </a>
                  </li>
                </ul>
            ...
            <li class="nav-item">
              ...
              <div class="collapse {{ (request()->is('panel/configuraciones/*')) ? 'show' : '' }}" id="sidebarConfig">
                <ul class="nav nav-sm flex-column">
                  <li class="nav-item">
                    <a href="" class="nav-link {{ (request()->is('panel/configuraciones/general*')) ? 'active' : '' }}">
                      General
                    </a>
                    <a href="" class="nav-link {{ (request()->is('panel/configuraciones/seccion_uno*')) ? 'active' : '' }}">
                      Sección uno
                    </a>
                    <a href="" class="nav-link {{ (request()->is('panel/configuraciones/seccion_tres*')) ? 'active' : '' }}">
                      Sección tres
                    </a>
                    <a href="" class="nav-link {{ (request()->is('panel/configuraciones/menu*')) ? 'active' : '' }}">
                      Menú
                    </a>
                    <a href="" class="nav-link {{ (request()->is('panel/configuraciones/faq*')) ? 'active' : '' }}">
                      FAQ
                    </a>
                    <a href="" class="nav-link {{ (request()->is('panel/configuraciones/galeria*')) ? 'active' : '' }}">
                      Galería
                    </a>
                    <a href="" class="nav-link {{ (request()->is('panel/configuraciones/slider*')) ? 'active' : '' }}">
                      Slider
                    </a>
                  </li>
            ...
            <li class="nav-item">
              <a class="nav-link {{ (request()->is('panel/ventas*')) ? 'active' : '' }}" href="" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="sidebarVenta">
                <i class="fe fe-shopping-cart"></i> Ventas
              </a>
              <div class="collapse {{ (request()->is('panel/ventas*')) ? 'show' : '' }}" id="sidebarVenta">
                <ul class="nav nav-sm flex-column">
                  <li class="nav-item">
                    <a href="" class="nav-link {{ (request()->is('panel/ventas/pedidos*')) ? 'active' : '' }}">
                      Pedidos
                    </a>
            ...
            <li class="nav-item">
              <a class="nav-link {{ (request()->is('panel/navegacion*')) ? 'active' : '' }}" href="">
                <i class="fe fe-grid"></i> Navegación
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link {{ (request()->is('panel/mensajes*')) ? 'active' : '' }}" href="">
                <i class="fe fe-mail"></i> Mensajes
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link {{ (request()->is('panel/usuario*')) ? 'active' : '' }}" href="">
